...
class FocalModulation(nn.Module):
    ...
    def forward(self, x):
        ...
        # store original ctx for global context calculation
        ctx_original = ctx
        ...
        # calculate global context from original ctx
        ctx_global = self.act(ctx_original.mean(2, keepdim=True).mean(3, keepdim=True))
