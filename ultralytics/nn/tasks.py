...
# C3K2修改
from ultralytics.nn.C3k2.C3k2_GCBlock import C3k2_GCBlock
from ultralytics.nn.C3k2.C3k2_HMHA import C3k2_HMHA
from ultralytics.nn.C3k2.C3k2_Mona import C3k2_Mona
from ultralytics.nn.C3k2.C3k2_MambaOut import C3k2_MambaOut
...
from ultralytics.nn.C3k2.C3k2_wConv2d import C3k2_wConv2d
from ultralytics.nn.C3k2.C3k2_SCConv2023 import C3k2_SCConv2023
from ultralytics.nn.C3k2.C3k2_DBB import C3k2_DBB
from ultralytics.nn.C3k2.C3k2_PPA import C3k2_PPA
from ultralytics.nn.C3k2.C3k2_MSBlock import C3k2_MSBlock
from ultralytics.nn.C3k2.C3k2_DySnakeConv import C3k2_DySnakeConv
from ultralytics.nn.C3k2.C3k2_DWR import C3k2_DWR
from ultralytics.nn.C3k2.C3k2_DWRSeg import C3k2_DWRSeg
from ultralytics.nn.C3k2.C3k2_DLKA import C3k2_DLKA
from ultralytics.nn.C3k2.C3k2_ODConv import C3k2_ODConv
from ultralytics.nn.C3k2.C3k2_DEConv import C3k2_DEConv
from ultralytics.nn.C3k2.C3k2_WDBB import C3k2_WDBB
from ultralytics.nn.C3k2.C3k2_DeepDBB import C3k2_DeepDBB
from ultralytics.nn.C3k2.C3k2_MogaBlock import C3k2_MogaBlock
from ultralytics.nn.C3k2.C3k2_iRMB import C3k2_iRMB
from ultralytics.nn.C3k2.C3k2_OREPA import C3k2_OREPA
from ultralytics.nn.C3k2.C3k2_MLCA import C3k2_MLCA
from ultralytics.nn.C3k2.C3k2_AKConv import C3k2_AKConv
from ultralytics.nn.C3k2.C3k2_DynamicConv import C3k2_DynamicConv
from ultralytics.nn.C3k2.C3k2_RepViTBlock import C3k2_RepViTBlock
from ultralytics.nn.C3k2.C3k2_RetBlock import C3k2_RetBlock
from ultralytics.nn.C3k2.C3k2_Faster_CGLU import C3K2_FasterBlock_CGLU
from ultralytics.nn.C3k2.C3k2_WTConv import C3k2_WTConv
from ultralytics.nn.C3k2.C3k2_EFAttention import C3k2_EFAttention
...
from ultralytics.nn.featureFusion.RepGFPN import RepCSPStage
...
from ultralytics.nn.attention.BMFPN import BMFPN, BMFPN_Concat2, BMFPN_Concat3


# Conv卷积修改
from ultralytics.nn.conv.PConv import PConv  # 风车卷积
from ultralytics.nn.conv.LDConv import LDConv  # 线性可变卷积
from ultralytics.nn.conv.RFB import BasicRFB  # RFB感受野多分支卷积结构
from ultralytics.nn.conv.C3k2_SCConv import C3k2_SCConv
from ultralytics.nn.conv.C3k2_SCConv_D import C3k2_SCConv_D
...
from ultralytics.nn.conv.MultiOrderGateAggregation import MultiOrderGatedAggregation
from ultralytics.nn.conv.ChannelAggregationFFN import ChannelAggregationFFN



# 下采样
from ultralytics.nn.otherModules.ADown import ADown
from ultralytics.nn.otherModules.DRFD import DRFD
from ultralytics.nn.otherModules.DRFD import SRFD
from ultralytics.nn.otherModules.WaveletPool import WaveletPool, WaveletUnPool
from ultralytics.nn.otherModules.PST import PST
from ultralytics.nn.otherModules.SMFA import SMFA
...
def parse_model(d, ch, verbose=True):
    ...
    base_modules = frozenset({
        ...
        SCDown, C2fCIB, A2C2f, CSPStage, SSAM, CAAM, GCT, PConv, LDConv,
        BasicRFB, C3k2_GCBlock, ADown, DRFD, SRFD, C3k2_SCConv, C3k2_SCConv_D,
        BMFPN, BMFPN_Concat2, BMFPN_Concat3, SPPF_LSKA, C2PSA_CPIASA,
        C2PSA_Mona, C2PSA_EDFFN, C2PSA_DML, C2PSA_MSLA, C3k2_HMHA, C3k2_Mona,
        C3k2_MambaOut, C3k2_DBlock, C3k2_EVA, C3k2_LSConv, C3k2_ARConv,
        C3k2_FDConv, C3k2_SFSConv, C3k2_wConv2d, C3k2_SCConv2023, C3k2_DBB,
        C3k2_PPA, C3k2_MSBlock, C3k2_DySnakeConv, C3k2_DWR, C3k2_DWRSeg,
        C3k2_DLKA, C3k2_ODConv, C3k2_DEConv, C3k2_WDBB, C3k2_DeepDBB,
        C3k2_MogaBlock, C3k2_iRMB, C3k2_OREPA, C3k2_MLCA, C3k2_AKConv,
        C3k2_DynamicConv, C3k2_RepViTBlock, C3k2_RetBlock,
        C3K2_FasterBlock_CGLU, C3k2_WTConv, C3k2_EFAttention, C3k2_EBlock,
        C3k2_FMB, MultiKernelDepthwiseConv, wConv2d, DynamicConv, ODConv2d,
        SAConv2d, SPConv, ScConv, RFAConv, RFCBAMConv, RFCAConv, CAConv,
        CBAMConv, DBB, RefConv, ChannelAggregationFFN, GSConv, VoVGSCSP,
        RepCSPStage
    })
    # 仅保留需要重复堆叠的模块，SSAM/CAAM移除
    repeat_modules = frozenset({
        BottleneckCSP, C1, C2, C2f, C3k2, C2fAttn, C3, C3TR, C3Ghost, C3x,
        RepC3, C2fPSA, C2fCIB, C2PSA, A2C2f, CSPStage, C3k2_SCConv,
        C3k2_SCConv_D, C2PSA_CPIASA, C2PSA_Mona, C2PSA_EDFFN, C2PSA_DML,
        C2PSA_MSLA, C3k2_HMHA, C3k2_Mona, C3k2_MambaOut, C3k2_DBlock,
        C3k2_EVA, C3k2_LSConv, C3k2_ARConv, C3k2_FDConv, C3k2_SFSConv,
        C3k2_wConv2d, C3k2_SCConv2023, C3k2_DBB, C3k2_PPA, C3k2_MSBlock,
        C3k2_DySnakeConv, C3k2_DWR, C3k2_DWRSeg, C3k2_DLKA, C3k2_ODConv,
        C3k2_DEConv, C3k2_WDBB, C3k2_DeepDBB, C3k2_MogaBlock, C3k2_iRMB,
        C3k2_OREPA, C3k2_MLCA, C3k2_AKConv, C3k2_DynamicConv, C3k2_RepViTBlock,
        C3k2_RetBlock, C3K2_FasterBlock_CGLU, C3k2_WTConv, C3k2_EFAttention,
        C3k2_EBlock, C3k2_FMB, RepCSPStage
    })

    # 单次遍历所有层（backbone + head）
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):
        # 解析模块（优先全局变量，再torch.nn，再torchvision）
        if "nn." in m:
            m_module = getattr(torch.nn, m[3:])
        elif "torchvision.ops." in m:
            m_module = getattr(__import__("torchvision").ops, m[16:])
        else:
            m_module = globals()[m]  # 解析SSAM/CAAM等自定义模块
        # 解析参数中的字符串（如将"nc"替换为实际类别数）
        ...
        # -------------------------- 适配SSAM/CAAM的参数解析 --------------------------
        if m_module is SSAM:
            # SSAM参数：in_channels, groups=4, reduction_ratio=2, dropout=0.1
            c1 = ch[f]  # 输入通道来自f层
            c2 = make_divisible(min(args[0], max_channels) * width, 8)  # 输出通道缩放
            # 重新构造参数：[in_channels, groups, reduction_ratio, dropout]
            args = [c1, *args[1:]]  # args[0]替换为实际输入通道c1，保留后续参数
        elif m_module is CAAM:
            # CAAM参数：dim, squeeze_factor=4, dropout=0.1
            c1 = ch[f]
            c2 = make_divisible(min(args[0], max_channels) * width, 8)
            args = [c1, *args[1:]]  # dim替换为实际输入通道c1
        elif m_module in {FocalModulation}:
            args = [ch[f], *args]
        elif m_module in [ScConv]:
            args = [ch[f]]
        elif m_module is space_to_depth:
            c2 = 4 * ch[f]
        elif m_module in {OREPA}:
            args = [ch[f], *args]
        elif m_module is SDI:
            args = [[ch[x] for x in f]]
        elif m_module in {MultiOrderGatedAggregation}:
            args = [ch[f]]
        elif m_module is PST:
        ...
        elif m_module in {SMFA}:
            c2 = ch[f]
            args = [ch[f]]
        # -------------------------- C3k2_SCConv的参数解析 -----------------------
        elif m_module is C3k2_SCConv:
            c1, c2 = ch[f], args[0]
            c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]  # 替换输入/输出通道
            # 添加n参数用于重复次数
            args.insert(2, n)
            n = 1
            if scale in "mlx":  # 与C3k2相同处理
                args[4] = True  # 设置c3k参数
        # -------------------------- C3k2_SCConv的参数解析 -----------------------
        elif m_module is C3k2_SCConv_D:
            c1, c2 = ch[f], args[0]
            c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]  # 替换输入/输出通道
            # 添加n参数用于重复次数
            ...
            if scale in "mlx":  # 与C3k2相同处理
                args[4] = True  # 设置c3k参数
        # -------------------------- BMFPN模块的参数解析 --------------------------
        elif m_module is BMFPN:
            # BMFPN参数：in_channels_list, out_channels, n_inputs, epsilon=1e-4
            in_channels_list = [ch[x] for x in f] if isinstance(f, list) else [ch[f]]
            c2 = make_divisible(min(args[0], max_channels) * width, 8) if args[0] != nc else nc
            n_inputs = len(in_channels_list) if isinstance(f, list) else 1
            args = [in_channels_list, c2, n_inputs, *args[1:]]
        elif m_module is BMFPN_Concat2:
            # BMFPN_Concat2参数：in_channels_list, out_channels, dimension=1
            # 确保f是包含两个元素的列表
            if not isinstance(f, list) or len(f) != 2:
                raise ValueError(f"BMFPN_Concat2 requires 2 input features, got f={f}")
            in_channels_list = [ch[x] for x in f]
            c2 = make_divisible(min(args[0], max_channels) * width, 8) if args[0] != nc else nc
            args = [in_channels_list, c2, *args[1:]]
        elif m_module is BMFPN_Concat3:
            # BMFPN_Concat3参数：in_channels_list, out_channels, dimension=1
            # 确保f是包含三个元素的列表
            if not isinstance(f, list) or len(f) != 3:
                raise ValueError(f"BMFPN_Concat3 requires 3 input features, got f={f}")
            in_channels_list = [ch[x] for x in f]
            c2 = make_divisible(min(args[0], max_channels) * width, 8) if args[0] != nc else nc
            args = [in_channels_list, c2, *args[1:]]
        # -------------------------- 原有模块的参数解析 --------------------------
        elif m_module in {WaveletPool}:
            c1, c2 = ch[f], ch[f] * 4  # WaveletPool 将通道数乘以4
        elif m_module in {WaveletUnPool}:
            c1, c2 = ch[f], ch[f] // 4  # WaveletUnPool 将通道数除以4
        elif m_module in base_modules:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # 非分类层，通道缩放
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            # 特殊模块的参数适配
            if m_module is C2fAttn:
                args[1] = make_divisible(min(args[1], max_channels // 2) * width, 8)
                args[2] = int(max(round(min(args[2], max_channels // 2 // 32)) * width, 1) if args[2] > 1 else args[2])
            args = [c1, c2, *args[1:]]  # 替换输入/输出通道
            # 重复模块插入n
            if m_module in repeat_modules:
                args.insert(2, n)
                n = 1
            # 其他特殊模块适配
            if m_module is C3k2 and scale in "mlx":
                legacy = False
                args[3] = True
            if m_module is A2C2f and scale in "lx":
                legacy = False
                args.extend((True, 1.2))
            if m_module is C2fCIB:
                legacy = False
        # -------------------------- 其他特殊模块 --------------------------
        elif m_module in {EfficientViT_M0, EfficientViT_M1, EfficientViT_M2, EfficientViT_M3, EfficientViT_M4, EfficientViT_M5}:
            m_module = m_module(*args)
            c2 = m_module.channels
        elif m_module in {fasternet_t0, fasternet_t1, fasternet_t2, fasternet_s, fasternet_m, fasternet_l}:
            m_module = m_module(*args)
            c2 = m_module.channels
        elif m_module is AIFI:
            args = [ch[f], *args]
        elif m_module in {HGStem, HGBlock}:
            c1, cm, c2 = ch[f], args[0], args[1]
            args = [c1, cm, c2, *args[2:]]
            if m_module is HGBlock:
                args.insert(4, n)
                n = 1
        elif m_module is ResNetLayer:
            c2 = args[1] if args[3] else args[1] * 4
        elif m_module is torch.nn.BatchNorm2d:
            args = [ch[f]]
        elif m_module is Concat:
            c2 = sum(ch[x] for x in f)
        elif m_module in {Detect, WorldDetect, YOLOEDetect, Segment, YOLOESegment, Pose, OBB, ImagePoolingAttn, v10Detect}:
            args.append([ch[x] for x in f])
            if m_module in {Segment, YOLOESegment}:
                args[2] = make_divisible(min(args[2], max_channels) * width, 8)
            if m_module in {Detect, YOLOEDetect, Segment, YOLOESegment, Pose, OBB}:
                m_module.legacy = legacy
        elif m_module is RTDETRDecoder:
            args.insert(1, [ch[x] for x in f])
        elif m_module is CBLinear:
            c2 = args[0]
            c1 = ch[f]
            args = [c1, c2, *args[1:]]
        elif m_module is CBFuse:
            c2 = ch[f[-1]]
        elif m_module in {TorchVision, Index}:
            c2 = args[0]
            c1 = ch[f]
            args = [*args[1:]]
        elif m_module is CGAFusion:
            c2 = ch[f[1]]
            args = [c2, *args]
        else:
            c2 = ch[f]
        ...
        # 构建模块（n>1时堆叠，否则直接实例化）
        if n > 1:
            m_ = nn.Sequential(*(m_module(*args) for _ in range(n)))
        else:
            m_ = m_module(*args)
        
        # 模块信息记录
        t = str(m_module)[8:-2].replace('__main__.', '')  # 模块类型
        m_.np = sum(x.numel() for x in m_.parameters())  # 参数数量
        m_.i, m_.f, m_.type = i, f, t  # 索引、来源层、类型（移除错误的+4偏移）
        ...
        if isinstance(c2, list):
            ch.extend(c2)
            # 补零保证长度（仅针对特殊backbone，YOLO11一般无需）
