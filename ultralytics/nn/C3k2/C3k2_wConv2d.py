...
class Bottleneck_wConv2d(Bottleneck):
...
class C3k_wConv2d(C3k):
    def __init__(self, c1, c2, n=1, den=None, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(Bottleneck_wConv2d(c_, c_, shortcut, g, k=(k, k), den=den, e=1.0) for _ in range(n)))

class C3k2_wConv2d(C3k2):
    def __init__(self, c1, c2, n=1, den=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_wConv2d(self.c, self.c, 2, den, shortcut, g) if c3k else Bottleneck_wConv2d(self.c, self.c, shortcut, g, den=den) for _ in range(n))
