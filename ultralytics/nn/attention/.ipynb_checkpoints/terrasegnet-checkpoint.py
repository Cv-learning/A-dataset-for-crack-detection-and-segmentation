# IEEE Access terrasegnet by AI Little monster
import torch
    ...
    def __init__(self, in_channels, groups=4, reduction_ratio=2, dropout=0.1):
        ...
        self.spectral_convs = nn.ModuleList([
            nn.Sequential(
                ...
                nn.Conv2d(
                    self.group_channels,
                    max(4, self.group_channels // reduction_ratio),
                    1
                ),
...
class CAAM(nn.Module):
    ...
    def __init__(self, dim, squeeze_factor=4, dropout=0.1):
        ...
        self.unsqueeze_proj = nn.Sequential(
            # Output dari attn (setelah h_conv/w_conv) adalah squeezed_dim
    ...
    def forward(self, x):
        ...
        h_attn = self.h_conv(h_pooled_features)  # [B, squeezed_dim, H, 1]
        ...
        w_attn = self.w_conv(w_pooled_features)  # [B, squeezed_dim, 1, W]
